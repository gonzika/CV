            ...
            <div className="main__profile main__profile--nopadding flex works">
                <div className="work work--full">
                    <div>
                        ...
                        <div>
                            Браузерная онлайн игра, о которой я мечтал в детстве. Шутка. В мечтах она была круче)) Начал разработку паралельно курсу вебразработки.
                            <p>Реализовано: регистрация, перемещение по игровому полю, распознавание других игроков, чат, урон по клетке, регенерация, респаун, автологаут при бездействии с записью в БД.</p>
                            <p>На видео продемонстрировано как один игрок убивает двух других (подсвечены красным), что отражено их перемещением на респаун (клетка 1:1).</p>
                        </div>
                    </div>
