        ...
        <div>
            ...
            <nav className="nav">
                <div>
                    ...
                    <NavLink onClick={() => closeMenu()} activeClassName="nav__link--active" to={way + "/works"} className="nav__link">Мои работы</NavLink>
                    <NavLink onClick={() => closeMenu()} activeClassName="nav__link--active" to={way + "/awards"} className="nav__link">Мои награды</NavLink>
