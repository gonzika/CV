...
function Navbar() {
    ...
    return (
        <div>
            ...
            <nav className="nav">
                <div>
                    <NavLink onClick={() => closeMenu()} activeClassName="nav__link--active" exact to="/" className="nav__link">Обо мне</NavLink>
                    <NavLink onClick={() => closeMenu()} activeClassName="nav__link--active" to="/works" className="nav__link">Мои работы</NavLink>
                    <NavLink onClick={() => closeMenu()} activeClassName="nav__link--active" to="/awards" className="nav__link">Мои награды</NavLink>
