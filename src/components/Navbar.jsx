...
function Navbar() {
    ...
    return (
        <div>
            <input type="checkbox" name="toggler-input" id="toggler-input" />
            <label id="toggler" htmlFor="toggler-input">
                <span></span>
                <span></span>
                <span></span>
            </label>
